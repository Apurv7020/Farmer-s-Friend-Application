...
public class CropRateAdater extends RecyclerView.Adapter<CropRateAdater.ViewHolder> {

    public List<CropRatesReq> blog_list;
    ...
    public CropRateAdater(List<CropRatesReq> blog_list) {
        this.blog_list = blog_list;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_crop_rate, parent, false);
...
//        final String PostId = blog_list.get(position).FacebookPostId;
        ...
        holder.productNameTxt.setText("" + blog_list.get(position).getTitle());
        holder.rateTxt.setText("₹" + blog_list.get(position).getRate() + "/-");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView productNameTxt, rateTxt, Txt3, Txt4, Txt5;
        private View mView;
